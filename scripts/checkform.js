...
/*
	with (document.forms["myform"])
  	{
	FunctionDate.value = FunctionDateYear.value + '-' + FunctionDateMonth[FunctionDateMonth.selectedIndex].value + '-' + FunctionDateDay.value;
...
//copyright (c)1998,2002 Yaromat.com
  ...
  if (s!=''){alert('Please complete the following fields :\t\t\t\t\t\n\n'+s)}
